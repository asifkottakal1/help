...
<head>
	<meta charset="UTF-8">
	<title>Foody HTML Template by Jewel Theme</title>
	...
	<script src="<?php echo base_url(); ?>/assets/js/modernizr-2.8.0.min.js"></script>
	...
	<link href="<?php echo base_url(); ?>/assets/css/linecons-font-style.css" rel="stylesheet">

	<!-- Plugins  -->
	<link href="<?php echo base_url(); ?>/assets/css/jquery.fs.boxer.css" rel="stylesheet" /> 
		...
		<div id="main-menu" class="navbar navbar-default"> 
			...
			<nav class="navbar-collapse clearfix" role="navigation">
				...
				<ul id="" class="nav navbar-nav">
					...
					<li><a href="<?php echo site_url();?>/welcome/order" > Order details</a></li>
					<li><a href="<?php echo site_url();?>/welcome/bills" > Bill details</a></li>
					<li><a href="<?php echo site_url();?>/welcome/contact">Contact</a></li>
					<li><a href="<?php echo site_url();?>/welcome/bill">Billing section</a></li>
				</ul> <!-- /.nav .navbar-nav -->
			</nav> <!-- /.navbar-collapse  --> 
